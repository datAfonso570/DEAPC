...
<body class="general-body">
    ...
    <div class="">
        <form action="orderInfo.php" method="POST">
            <label class="label-font">Order Number </label><input type="text" name="searchID"><button
                type="Submit">Search</button>
            <input type="hidden" name="page" value="uti2.html">
        </form>
    </div>
    ...
    <script>
        ...
        function jsSubmit(e) {
            if (!allChecked() && e.id != "cancel") {
                ...
                fetch("http://localhost/deapc/alterTable.php", {
